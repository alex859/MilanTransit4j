...
public class JourneyPattern {
    ...
    @JsonProperty("Line")
    private it.atm.json.allRoutes.Line Line;
    @JsonProperty("Stops")
     ...
     */
    @JsonProperty("Line")
    public it.atm.json.allRoutes.Line getLine() {
        return Line;
    }
     ...
     */
    @JsonProperty("Line")
    public void setLine(it.atm.json.allRoutes.Line Line) {
        this.Line = Line;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof JourneyPattern) == false) {
            return false;
        }
        JourneyPattern rhs = ((JourneyPattern) other);
