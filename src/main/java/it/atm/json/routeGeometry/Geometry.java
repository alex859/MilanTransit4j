...
public class Geometry {
    ...
    private it.atm.json.routeGeometry.BoundingBox_NE BoundingBox_NE;
    @JsonProperty("BoundingBox_SW")
    private it.atm.json.routeGeometry.BoundingBox_SW BoundingBox_SW;
    @JsonIgnore
     ...
     */
    @JsonProperty("BoundingBox_NE")
    public it.atm.json.routeGeometry.BoundingBox_NE getBoundingBox_NE() {
     ...
     */
    @JsonProperty("BoundingBox_NE")
    public void setBoundingBox_NE(it.atm.json.routeGeometry.BoundingBox_NE BoundingBox_NE) {
     ...
     */
    @JsonProperty("BoundingBox_SW")
    public it.atm.json.routeGeometry.BoundingBox_SW getBoundingBox_SW() {
     ...
     */
    @JsonProperty("BoundingBox_SW")
    public void setBoundingBox_SW(it.atm.json.routeGeometry.BoundingBox_SW BoundingBox_SW) {
